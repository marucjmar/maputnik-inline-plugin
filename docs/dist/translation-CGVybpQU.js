//#region src/locales/ko/translation.json
var e = "베이스", t = "방위각", n = "취소", r = "중심 좌표", i = "닫기", a = "클러스터", o = "접기", s = "주석", c = "디버그", l = "기본값", u = "삭제", d = "복제", f = "인코딩", p = "펼치기", m = "필터", h = "함수", g = "GeoJSON", _ = "도움말", v = "숨기기", y = "이미지", b = "검사", x = "키", S = "레이어", C = "레이어", w = "링크", T = "로딩", E = "맵", D = "이름", O = "열기", k = "옵션", A = "소유자", j = "경사각", M = "투영법", N = "저장", P = "검색", F = "단축키", I = "표시", L = "소스", R = "소스", z = "기준점", B = "유형", V = "값", H = "비디오", U = "보기", W = "줌", G = {
