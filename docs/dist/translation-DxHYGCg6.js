//#region src/locales/he/translation.json
var e = "בסיס", t = "כיוון", n = "ביטול", r = "מרכז", i = "סגירה", a = "קיבוץ", o = "הקטנה", s = "הערות", c = "דיבאג", l = "ברירת המחדל", u = "מחיקה", d = "שכפול", f = "קידוד", p = "הגדלה", m = "סינון", h = "פונקציה", g = "GeoJSON", _ = "עזרה", v = "הסתרה", y = "תמונה", b = "בדיקה", x = "מפתח", S = "שכבה", C = "שכבות", w = "קישורים", T = "טוען", E = "מפה", D = "שם", O = "פתיחה", k = "אפשרויות", A = "שייך ל", j = "זווית", M = "הטלה", N = "שמור", P = "חיפוש", F = "קיצורי דרך", I = "הצגה", L = "מקור", R = "מקורות", z = "עצירות", B = "סוג", V = "ערך", H = "וידאו", U = "תצוגה", W = "זום", G = {
